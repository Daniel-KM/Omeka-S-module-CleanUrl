...
// Copy this file in the main config folder, beside database.ini and local.config.php.

// TODO Use the main default site slug from the settings automatically.

// In order to have a main site without "/s/site-slug", fill your main site slug
// here, so it won’t be used. Don't add trailing "/".
